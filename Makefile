...
image: | root/bin/sh root/lib/x86_64-linux-gnu/libm.so.6 root/lib/x86_64-linux-gnu/libz.so.1 root/lib/x86_64-linux-gnu/libdl.so.2 root/lib/x86_64-linux-gnu/libc.so.6 root/lib/x86_64-linux-gnu/libc.so.6 root/lib/x86_64-linux-gnu/libpthread.so.0 root/lib/x86_64-linux-gnu/librt.so.1 root/lib64/ld-linux-x86-64.so.2 root/usr/lib/x86_64-linux-gnu/gconv/UTF-16.so root/usr/lib/x86_64-linux-gnu/gconv/UTF-32.so root/usr/lib/x86_64-linux-gnu/gconv/UTF-7.so root/usr/lib/x86_64-linux-gnu/gconv/gconv-modules root/usr/lib/x86_64-linux-gnu/gconv/gconv-modules.cache root/usr/lib/x86_64-linux-gnu/libgmp.so.10
